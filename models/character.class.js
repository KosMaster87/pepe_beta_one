class Character extends MoveableObject {
  ...
  isMovingRight() {
    return (
      this.world.keyboard.RIGHT && this.x < this.world.level.level_end_x - 300
    );
  }
  ...
  animate() {
    world.intervals.push(
      (this.walking = setInterval(() => this.setMoving(), 1000 / 60))
    );
    world.intervals.push(
      (this.walking = setInterval(() => this.setJumping(), 1000 / 60))
    );
    world.intervals.push(
      setInterval(() => this.animateJump(), (1000 / 60) * 9)
    );
    world.intervals.push(
      (this.moving = setInterval(() => this.animateMoving(), 1000 / 40))
    );
    world.intervals.push(
      (this.hurting = setInterval(() => this.animateHurt(), (1000 / 60) * 6))
    );
    world.intervals.push(
    ...
    world.intervals.push(
      setInterval(() => this.startDeadAnimation(), 1000 / 7)
    );
